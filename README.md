...
##### 1. Clone repository
```
$ git clone git@github.com:kredo-school/laravel_insta.git
```
...
##### Name: localhost/laravel_insta
##### HOST: localhost
##### USERNAME: root
##### PASSWORD:     
##### DATABASE: laravel_insta
##### PORT: 3306
