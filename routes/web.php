...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('/suggested', [HomeController::class, 'suggestedAllUsers'])->name('suggested');
    ...
    Route::patch('/profile/password/update', [ProfileController::class, 'updatePassword'])->name('profile.password');
